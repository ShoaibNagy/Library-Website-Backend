    ...
    <div id="toc">
                ...
                <li class="tocify-item level-1" data-unique="authentication">
                    <a href="#authentication">Authentication</a>
                                ...
                                <a href="#authentication-POSTapi-logout">Logout the authenticated user</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="book-management">
                    <a href="#book-management">Book Management</a>
                                ...
                                <a href="#book-management-POSTapi-books">Create a new book</a>
                            </li>
                                ...
                                <a href="#book-management-GETapi-books">List all books</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="book-management-GETapi-books--id-">
                                <a href="#book-management-GETapi-books--id-">Get a specific book</a>
                            </li>
                                                                        </ul>
                            </ul>
                ...
                <li class="tocify-item level-1" data-unique="endpoints">
                    ...
                    <ul id="tocify-header-loan-operations" class="tocify-header">
                <li class="tocify-item level-1" data-unique="loan-operations">
                    <a href="#loan-operations">Loan Operations</a>
                </li>
                                    <ul id="tocify-subheader-loan-operations" class="tocify-subheader">
                                                    <li class="tocify-item level-2" data-unique="loan-operations-GETapi-loans-overdue">
                                <a href="#loan-operations-GETapi-loans-overdue">List overdue loans</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="loan-operations-POSTapi-loans--id--return">
                                <a href="#loan-operations-POSTapi-loans--id--return">Return a book</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="loan-operations-POSTapi-loans-borrow">
                                <a href="#loan-operations-POSTapi-loans-borrow">Borrow a book</a>
                            </li>
                                                                                <li class="tocify-item level-2" data-unique="loan-operations-GETapi-loans-my-history">
                                <a href="#loan-operations-GETapi-loans-my-history">Get my loan history</a>
                            </li>
                                                                        </ul>
                            </ul>
            </div>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The new password. Example: <code>newpassword</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
            <b style="line-height: 2;"><code>password_confirmation</code></b>&nbsp;&nbsp;
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The new password confirmation. Example: <code>newpassword</code></p>
        </div>
        </form>

                    <h2 id="authentication-POSTapi-logout">Logout the authenticated user</h2>
...
<p>Example: <code>application/json</code></p>
    ...
    <p>APIs for managing books</p>
                                ...
                                <h2 id="book-management-POSTapi-books">Create a new book</h2>
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The title of the book. Example: <code>Harry Potter</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>string</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The ISBN of the book. Example: <code>1234567890</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="category_id"                data-endpoint="POSTapi-books"
               value="1"
               data-component="body">
    <br>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The total number of copies. Example: <code>10</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The number of available copies. Example: <code>10</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The year of publication. Example: <code>2000</code></p>
        </div>
                <div style=" padding-left: 28px;  clear: unset;">
...
<i>optional</i> &nbsp;
 &nbsp;
               ...
               data-component="body">
    <br>
<p>The description of the book. Example: <code>A wizard boy...</code></p>
        </div>
        </form>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="category_id"                data-endpoint="PUTapi-books--id-"
               value="1"
               data-component="body">
    <br>
<p>The ID of the category. Example: <code>1</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="total_copies"                data-endpoint="PUTapi-books--id-"
               value="10"
               data-component="body">
    <br>
<p>The total number of copies. Example: <code>10</code></p>
...
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="available_copies"                data-endpoint="PUTapi-books--id-"
               value="10"
               data-component="body">
    <br>
<p>The number of available copies. Example: <code>10</code></p>
...
<p>The ID of the book. Example: <code>1</code></p>
                    ...
                    <h2 id="book-management-GETapi-books">List all books</h2>
...
<div class="bash-example">
    ...
    --get "http://localhost:8000/api/books?search=Harry+Potter&amp;category_id=1&amp;page=1" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<i>optional</i> &nbsp;
 &nbsp;
    ...
    <br>
<p>Filter by title, isbn, or author name. Example: <code>Harry Potter</code></p>
            </div>
                                    <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>category_id</code></b>&nbsp;&nbsp;
<small>integer</small>&nbsp;
<i>optional</i> &nbsp;
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="category_id"                data-endpoint="GETapi-books"
               value="1"
               data-component="query">
    <br>
...
<p>The page number. Example: <code>1</code></p>
                    ...
                    <h2 id="book-management-GETapi-books--id-">Get a specific book</h2>
...
<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/reset-password/architecto" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/reset-password/architecto"
);
...
<p>Example: <code>application/json</code></p>
                ...
                <h1 id="loan-operations">Loan Operations</h1>

    <p>APIs for managing book loans</p>

                                <h2 id="loan-operations-GETapi-loans-overdue">List overdue loans</h2>
...
<span id="example-requests-GETapi-loans-overdue">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/loans/overdue" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/loans/overdue"
);
...
<span id="example-responses-GETapi-loans-overdue">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-loans-overdue" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-loans-overdue"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-loans-overdue"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-loans-overdue" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-loans-overdue">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-loans-overdue" data-method="GET"
      data-path="api/loans/overdue"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-loans-overdue', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-loans-overdue"
                    onclick="tryItOut('GETapi-loans-overdue');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-loans-overdue"
                    onclick="cancelTryOut('GETapi-loans-overdue');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-loans-overdue"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/loans/overdue</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-loans-overdue"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-loans-overdue"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
                    ...
                    <h2 id="loan-operations-POSTapi-loans--id--return">Return a book</h2>
...
<span id="example-requests-POSTapi-loans--id--return">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/loans/1/return" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<span id="example-responses-POSTapi-loans--id--return">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-loans--id--return" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-loans--id--return"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-loans--id--return"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-loans--id--return" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-loans--id--return">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-loans--id--return" data-method="POST"
      data-path="api/loans/{id}/return"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-loans--id--return', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-loans--id--return"
                    onclick="tryItOut('POSTapi-loans--id--return');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-loans--id--return"
                    onclick="cancelTryOut('POSTapi-loans--id--return');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-loans--id--return"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-loans--id--return"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-loans--id--return"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="id"                data-endpoint="POSTapi-loans--id--return"
               value="1"
               data-component="url">
    <br>
<p>The ID of the loan. Example: <code>1</code></p>
                    ...
                    <h2 id="loan-operations-POSTapi-loans-borrow">Borrow a book</h2>
...
<span id="example-requests-POSTapi-loans-borrow">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request POST \
    "http://localhost:8000/api/loans/borrow" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json" \
    --data "{
    \"book_id\": 1
...
<span id="example-responses-POSTapi-loans-borrow">
            <blockquote>
            <p>Example response (201):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-POSTapi-loans-borrow" hidden>
    <blockquote>Received response<span
                id="execution-response-status-POSTapi-loans-borrow"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-POSTapi-loans-borrow"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-POSTapi-loans-borrow" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-POSTapi-loans-borrow">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-POSTapi-loans-borrow" data-method="POST"
      data-path="api/loans/borrow"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('POSTapi-loans-borrow', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-POSTapi-loans-borrow"
                    onclick="tryItOut('POSTapi-loans-borrow');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-POSTapi-loans-borrow"
                    onclick="cancelTryOut('POSTapi-loans-borrow');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-POSTapi-loans-borrow"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-black">POST</small>
            <b><code>api/loans/borrow</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="POSTapi-loans-borrow"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="POSTapi-loans-borrow"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
<small>integer</small>&nbsp;
 ...
 &nbsp;
                <input type="number" style="display: none"
               step="any"               name="book_id"                data-endpoint="POSTapi-loans-borrow"
               value="1"
               data-component="body">
    <br>
<p>The ID of the book to borrow. Example: <code>1</code></p>
        </div>
        </form>

                    <h2 id="loan-operations-GETapi-loans-my-history">Get my loan history</h2>
...
<span id="example-requests-GETapi-loans-my-history">
<blockquote>Example request:</blockquote>


<div class="bash-example">
    <pre><code class="language-bash">curl --request GET \
    --get "http://localhost:8000/api/loans/my-history" \
    --header "Content-Type: application/json" \
    --header "Accept: application/json"</code></pre></div>
...
<div class="javascript-example">
    <pre><code class="language-javascript">const url = new URL(
    "http://localhost:8000/api/loans/my-history"
);
...
<span id="example-responses-GETapi-loans-my-history">
            <blockquote>
            <p>Example response (200):</p>
        </blockquote>
                <pre>
...
<span id="execution-results-GETapi-loans-my-history" hidden>
    <blockquote>Received response<span
                id="execution-response-status-GETapi-loans-my-history"></span>:
    </blockquote>
    <pre class="json"><code id="execution-response-content-GETapi-loans-my-history"
      data-empty-response-text="<Empty response>" style="max-height: 400px;"></code></pre>
</span>
<span id="execution-error-GETapi-loans-my-history" hidden>
    <blockquote>Request failed with error:</blockquote>
    <pre><code id="execution-error-message-GETapi-loans-my-history">

Tip: Check that you&#039;re properly connected to the network.
If you&#039;re a maintainer of ths API, verify that your API is running and you&#039;ve enabled CORS.
You can check the Dev Tools console for debugging information.</code></pre>
</span>
<form id="form-GETapi-loans-my-history" data-method="GET"
      data-path="api/loans/my-history"
      data-authed="1"
      data-hasfiles="0"
      data-isarraybody="0"
      autocomplete="off"
      onsubmit="event.preventDefault(); executeTryOut('GETapi-loans-my-history', this);">
    <h3>
        Request&nbsp;&nbsp;&nbsp;
                    <button type="button"
                    style="background-color: #8fbcd4; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-tryout-GETapi-loans-my-history"
                    onclick="tryItOut('GETapi-loans-my-history');">Try it out ⚡
            </button>
            <button type="button"
                    style="background-color: #c97a7e; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-canceltryout-GETapi-loans-my-history"
                    onclick="cancelTryOut('GETapi-loans-my-history');" hidden>Cancel 🛑
            </button>&nbsp;&nbsp;
            <button type="submit"
                    style="background-color: #6ac174; padding: 5px 10px; border-radius: 5px; border-width: thin;"
                    id="btn-executetryout-GETapi-loans-my-history"
                    data-initial-text="Send Request 💥"
                    data-loading-text="⏱ Sending..."
                    hidden>Send Request 💥
            </button>
            ...
            <p>
            <small class="badge badge-green">GET</small>
            <b><code>api/loans/my-history</code></b>
        </p>
                <h4 class="fancy-heading-panel"><b>Headers</b></h4>
                                <div style="padding-left: 28px; clear: unset;">
                <b style="line-height: 2;"><code>Content-Type</code></b>&nbsp;&nbsp;
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Content-Type"                data-endpoint="GETapi-loans-my-history"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
...
&nbsp;
 ...
 &nbsp;
                <input type="text" style="display: none"
                              name="Accept"                data-endpoint="GETapi-loans-my-history"
               value="application/json"
               data-component="header">
    <br>
<p>Example: <code>application/json</code></p>
